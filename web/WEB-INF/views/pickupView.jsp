        ...
        <div class="main-page"> 
            ...
            <h2 class="title1">New Parcel</h2>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Package Pickup</li>
                </ol>
            ...
            <div class="form-three widget-shadow">
                <div class="form-title">
                    <h4>Enter pickup informations</h4>
                </div>
                <div class="form-body">

                    <form class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/pickup">

                            <div class="form-group">
                                <label class="col-md-2 control-label">Pickup Name</label>
                                <div class="col-md-8">
                                    <div class="input-group">							
                                        <span class="input-group-addon">
                                            <i class="fa fa-user"></i>
                                        </span>
                                        <input type="text" class="form-control1" placeholder="Pickup Name" name="pickup_name">
                                    </div>
                                </div>
                            </div>

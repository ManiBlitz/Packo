        ...
        <div class="main-page"> 
            ...
            <div class="form-three widget-shadow">
                ...
                <div class="form-body">
                    ...
                    <form class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/newadmin">
                            ...
                            <input type="hidden" name="residence_code" value="${sessionScope.residence.residence_code}"/>
